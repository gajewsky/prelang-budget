...
1000.times do
  expense = Expense.create!({operation_date: Faker::Date.between(1.year.ago, Date.today), description: Faker::Hipster.sentence, value: Faker::Number.decimal([2,2,2,2,3,3,3,4].sample, 2), subcategory_id: [*1..51].sample, user_id: [1,2].sample, to_divide: [true, false, false].sample })
